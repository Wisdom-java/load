...
public class CaMessage {
    static String topic = "ca_message_repair_bak";
    ...
    public static void main( String[] args ) {
        System.out.println("开始加载 ca_message");
        //服务器上的地址
        String path1 = "/data/log20210716";
        String path2 = "/var/log";
        ...
        try {
            ...
            for (int i = 0; i < fileList.length; i++) {
                ...
                for (int j = 0; j < files.length; j++) {
                    ...
                    if (fileName.contains("dsnet-core")){
                        continue;
                    }
                    System.out.println("filename:"+ fileName);
                    InputStream in = new FileInputStream(finalName + "/" + fileName);
